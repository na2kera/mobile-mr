...
| [10. MR Golf](./demos/10-golf/) | 08と同じ箱型コートの床をグリーンにしたパターゴルフ。パターはSwitchのJoy-Con（PCの[俯瞰画面](./demos/10-golf/overview.html)がWebHIDで振りを読み、サーバー経由で1打にする）。狙いは視線で構え、参加順に1打ずつ交代、3ホールの合計打数で勝負 | スマートフォン1台以上、壁と床に貼ったマーカー、Joy-Conを繋いだPC（Chrome。無ければ画面長押しで溜め打ち） |

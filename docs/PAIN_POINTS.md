...
- **関連**: `demos/03-marker-anchor/marker-detector.ts` の `pickValidPose()` / `node_modules/js-aruco2/src/posit1.js` の `pose()`（error1.euclidean < error2.euclidean 比較と isValid）
